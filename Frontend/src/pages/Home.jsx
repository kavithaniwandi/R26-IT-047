...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      >
        <div 
          className="absolute inset-0 bg-gradient-to-br from-primary-600/10 to-secondary-600/10"
          style={{
        ...
        {/* Floating Elements */}
        <motion.div
          className="absolute top-20 left-10 w-20 h-20 bg-disaster-500/20 rounded-full blur-xl"
          animate={{
            y: [0, -20, 0],
            x: [0, 10, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-20 right-10 w-32 h-32 bg-donation-500/20 rounded-full blur-xl"
          animate={{
            y: [0, 20, 0],
            x: [0, -10, 0],
          }}
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-disaster-600 via-primary-600 to-donation-600 bg-clip-text text-transparent">
              Hope in Crisis
            </h1>
          ...
          <motion.div
            ...
            className="mt-12 inline-flex items-center px-6 py-3 bg-red-50 border border-red-200 rounded-lg"
          >
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-primary-600 font-medium">{testimonial.impact}</span>
                </div>
              </motion.div>
            ))}
          </div>
