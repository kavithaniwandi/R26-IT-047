...
import { Eye, EyeOff, LogIn, Heart, Shield, AlertCircle } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="text-center space-y-6">
              <div className="w-20 h-20 bg-gradient-to-r from-disaster-500 to-donation-500 rounded-full flex items-center justify-center mx-auto">
                <Heart className="w-12 h-12 text-white" />
              </div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-disaster-600 to-donation-600 bg-clip-text text-transparent">
                Welcome Back to ReliefHub
              </h1>
              <p className="text-lg text-gray-600">
                Continue your journey of making a difference. Every login brings us closer to helping those in need.
              </p>
              
              <div className="space-y-4 pt-8">
                <div className="flex items-center space-x-3 text-left">
                  <Shield className="w-6 h-6 text-disaster-500 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-center space-x-3 text-left">
                  <Heart className="w-6 h-6 text-donation-500 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-gray-800">Make Impact</h3>
                    <p className="text-sm text-gray-600">Track your contributions and see the difference you make</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 text-left">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Access your relief dashboard</p>
            </div>
